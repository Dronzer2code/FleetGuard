        ...
        <div className="left-panel">
          ...
          <div className="vehicle-preview">
                ...
                <div className="street">
                  <div className="car">
                    <div className="car-body">
                      <div className="car-top-back"><div className="back-curve"></div></div>
                      <div className="car-gate"></div>
                      <div className="car-top-front"><div className="wind-sheild"></div></div>
                      <div className="bonet-front"></div>
                      <div className="stepney"></div>
                    </div>
                    <div className="boundary-tyre-cover"><div className="boundary-tyre-cover-back-bottom"></div><div className="boundary-tyre-cover-inner"></div></div>
                    <div className="tyre-cover-front"><div className="boundary-tyre-cover-inner-front"></div></div>
                    <div className="base-axcel"></div>
                    <div className="front-bumper"></div>
                    <div className="tyre"><div className="gap"></div></div>
                    <div className="tyre front"><div className="gap"></div></div>
            ...
            <div className="preview-details asymmetric-card">
              ...
              <p>Plate: <strong>{vehiclePlate}</strong></p>
              <p>Status: <span className="status-badge">OnDuty</span></p>
            </div>
          </div>
        ...
        <div className="right-panel">
          ...
          <form className="logistics-form" onSubmit={handleSubmit}>
              ...
              <div className="checkbox-grid">
                {['knocking', 'ticking', 'rattling', 'whining'].map(type => (
                  <div className="checkbox-group" key={type}>
                    ...
                    />
                    <label htmlFor={`sound-${type}`}>{type.charAt(0).toUpperCase() + type.slice(1)}</label>
                  </div>
                ))}
              </div>
              <div className="input-grid" style={{ marginTop: '1.5rem' }}>
                <div className="input-group">
                  <select 
                    ...
                    onChange={(e) => updateState('sounds', 'brakingSound', { ...formData.sounds.brakingSound, exists: e.target.value === 'yes' })}
                  >
                ...
                <div className="input-group">
                  <select 
                    ...
                    onChange={(e) => updateState('sounds', 'turningSound', { ...formData.sounds.turningSound, exists: e.target.value === 'yes' })}
                  >
                    <option value="no">No</option>
                    <option value="yes">Yes</option>
                  </select>
            ...
            <div className="form-section">
              ...
              <div className="checkbox-grid">
                {[
                  ...
                  { key: 'gearShiftingDifficulty', label: 'Gear shifting difficulty' },
              ...
              <div className="input-group" style={{ marginTop: '1rem' }}>
                <select 
                  ...
                  onChange={(e) => updateState('drivingBehavior', 'pulling', { exists: !!e.target.value, direction: e.target.value })}
                >
              ...
              {formData.evSpecific.isEV && (
                <>
                  {[
                    ...
                    { key: 'inverterNoise', label: 'Strange inverter/motor noise' }
                  ].map(item => (
                    <div className="toggle-wrapper" key={item.key}>
                      <label>{item.label}</label>
                      <label className="toggle-switch">
            ...
            <div className="form-section">
              ...
              <div className="input-grid">
                <div className="input-group">
                  <input type="file" multiple accept="image/*" onChange={(e) => handleFileChange('exterior', e)} />
                  <label style={{position: 'static', marginBottom: '0.5rem', display: 'block'}}>Exterior Photos</label>
                </div>
                <div className="input-group">
                  <input type="file" multiple accept="image/*" onChange={(e) => handleFileChange('problemAreas', e)} />
                  <label style={{position: 'static', marginBottom: '0.5rem', display: 'block'}}>Problem Areas</label>
                </div>
                <div className="input-group">
                  <input type="file" multiple accept=".pdf,image/*" onChange={(e) => handleFileChange('documents', e)} />
                  <label style={{position: 'static', marginBottom: '0.5rem', display: 'block'}}>Service Documents</label>
                </div>
              </div>
            </div>
            ...
            <div className="form-actions">
              ...
              <button type="submit" className="btn btn-primary" disabled={loading}>
                {loading ? (
                  <>
                    <i className="fa-solid fa-spinner fa-spin"></i> {loadingStep || 'Processing...'}
                  </>
                ) : (
                  <>
